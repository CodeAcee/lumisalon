...
import { ArrowLeft, MapPin, Building2, Camera, Check } from 'lucide-react-native';
import { useColors } from '../../src/theme/ThemeContext';
import { FontSize, BorderRadius } from '../../src/constants/theme';
import { Button } from '../../src/components/ui/Button';
import { useAppStore } from '../../src/store';

const PLACEHOLDER = 'https://images.unsplash.com/photo-1560066984-138dadb4c035?w=600&q=80';
  ...
  return (
    ...
    >
      ...
      <View style={styles(colors).header}>
        ...
        <Text style={styles(colors).headerTitle}>Add Location</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      >
        ...
        {/* Name */}
        <Text style={styles(colors).sectionLabel}>LOCATION NAME</Text>
        ...
        {nameError ? <Text style={styles(colors).errorText}>{nameError}</Text> : null}

        {/* Address */}
        <Text style={styles(colors).sectionLabel}>ADDRESS</Text>
      ...
      <View style={[styles(colors).bottomBar, { paddingBottom: insets.bottom + 16 }]}>
        <Button
          title="Add Location"
          onPress={handleSave}
...
const styles = (c: ReturnType<typeof useColors>) =>
  StyleSheet.create({
    ...
    sectionLabel: {
      fontSize: FontSize.xs, fontWeight: '700', color: c.textTertiary,
      letterSpacing: 1, marginHorizontal: 16, marginTop: 8,
    },
    formCard: {
    ...
    errorText: {
      fontSize: FontSize.sm, color: c.danger, marginHorizontal: 20, marginTop: -4,
    },
    bottomBar: {
      paddingHorizontal: 16, paddingTop: 12, backgroundColor: c.bgPrimary,
    },
  });
